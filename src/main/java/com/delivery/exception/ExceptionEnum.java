...
public enum ExceptionEnum {
    ...
    DUPLICATE_EMAIL(HttpStatus.CONFLICT, "U01", "User email duplicate."),
    DUPLICATE_NICKNAME(HttpStatus.CONFLICT, "U02", "User nickname duplicate."),
    DUPLICATE_PHONE(HttpStatus.CONFLICT, "U03", "User phone number duplicate."),
